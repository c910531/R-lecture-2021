...
url_list <- 'https://www.hanbit.co.kr/media/books/new_book_list.html?page='
url_list2 <- '&cate_cd=&srt=&searchKey=&keyWord='
...
for (li in lis) {
    ...
    for (i in 1:25) {
        url[i] <- paste0(url_list,i,url_list2)
        }    
    }
